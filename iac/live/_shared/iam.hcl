locals {
  ...
  #       For a module so important for security, I would recommend maintaining our own fork or clone.
  source_url = "${local.github_src}/Flaconi/terraform-aws-iam${local.github_tag_query}"
